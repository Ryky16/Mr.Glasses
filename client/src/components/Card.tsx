    ...
    <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 group">
      ...
      <div className="p-5">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-2 rounded-2xl text-1xl transition-all hover:scale-105 active:scale-95 shadow-lg"
        >
